...
\title{Daily fire forecasting over Western Highlands, Vietnam \\ using historical weather data} % Title
\date{\today} % Date for the report
\maketitle % Insert the title, author and date

\begin{center}
    \begin{tabular}{l l}
        Date Performed: & June 26, 2021                \\ % Date the experiment was performed
