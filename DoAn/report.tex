...
Tiếp theo đó khi đã xác nhận API này đủ điều kiện ra kiểm tra ý nghĩa của các thông số trong request, thử thay đổi thông số để kiểm tra dữ liệu kéo dài được đến bao lâu. Trên thực tế ta chỉ chọn một thời điểm đủ xa để chấp nhận được, nếu đạt sẽ crawl ngược thời gian đến khi hết crawl được thì dừng.

\includegraphics[width=6in]{images/checkpast.png}

Vì dữ liệu chấp nhận đến 2016 nên sẽ tiến hành crawl dữ liệu.
